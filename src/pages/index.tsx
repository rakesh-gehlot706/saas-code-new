                                ...
                                <div className="mb-10 inline-flex items-center gap-3 rounded-xl bg-white/5 px-4 py-3.5">
                                    <div className="inline-flex items-center gap-1">
                                        <svg width="14" height="13" viewBox="0 0 14 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path
                                                d="M6.31233 11.0019C6.57598 10.8428 6.90609 10.8428 7.16975 11.0019L9.88155 12.6387C10.5099 
                                                13.0179 11.285 12.4546 11.1182 11.7399L10.3985 8.65535C10.3285 8.35543 10.4304 8.04142 10.6632
                                                 7.83976L13.0602 5.76327C13.6149 5.28274 13.3184 4.37155 12.5871 4.30953L9.43297 4.04202C9.12635
                                                  4.01602 8.8593 3.82243 8.73921 3.53911L7.5049 0.626969C7.21901 -0.0475323 6.26307 -0.0475302 
                                                  5.97718 0.626969L4.74286 3.53911C4.62277 3.82243 4.35573 4.01602 4.04911 4.04202L0.894962 
                                                  4.30953C0.163677 4.37155 -0.13286 5.28273 0.421853 5.76327L2.81888 7.83976C3.05166 8.04142
                                                   3.15358 8.35543 3.0836 8.65535L2.36388 11.7399C2.19712 12.4546 2.97221 13.0179 3.60053 12.6387L6.31233 11.0019Z"
                                                fill="#FDB52A"
                                            />
                                        </svg>
                                        <svg width="14" height="13" viewBox="0 0 14 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path
                                                d="M6.31233 11.0019C6.57598 10.8428 6.90609 10.8428 7.16975
                                                 11.0019L9.88155 12.6387C10.5099 13.0179 11.285 12.4546 11.1182
                                                  11.7399L10.3985 8.65535C10.3285 8.35543 10.4304 8.04142 10.6632
                                                   7.83976L13.0602 5.76327C13.6149 5.28274 13.3184 4.37155 12.5871
                                                    4.30953L9.43297 4.04202C9.12635 4.01602 8.8593 3.82243 8.73921 
                                                    3.53911L7.5049 0.626969C7.21901 -0.0475323 6.26307 -0.0475302 
                                                    5.97718 0.626969L4.74286 3.53911C4.62277 3.82243 4.35573 4.01602 
                                                    4.04911 4.04202L0.894962 4.30953C0.163677 4.37155 -0.13286 5.28273
                                                     0.421853 5.76327L2.81888 7.83976C3.05166 8.04142 3.15358 8.35543
                                                      3.0836 8.65535L2.36388 11.7399C2.19712 12.4546 2.97221 13.0179 3.60053 12.6387L6.31233 11.0019Z"
                                                fill="#FDB52A"
                                            />
                                        </svg>
                                        <svg width="14" height="13" viewBox="0 0 14 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <svg width="14" height="13" viewBox="0 0 14 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path
                                                ...
                                                13.0179 11.285 12.4546 11.1182 11.7399L10.3985 8.65535C10.3285 8.35543 10.4304 8.04142 10.6632
                                                 7.83976L13.0602 5.76327C13.6149 5.28274 13.3184 4.37155 12.5871 4.30953L9.43297 4.04202C9.12635 
                                                 4.01602 8.8593 3.82243 8.73921 3.53911L7.5049 0.626969C7.21901 -0.0475323 6.26307 -0.0475302 5.97718 
                                                 0.626969L4.74286 3.53911C4.62277 3.82243 4.35573 4.01602 4.04911 4.04202L0.894962 4.30953C0.163677 4.37155
                                                  -0.13286 5.28273 0.421853 5.76327L2.81888 7.83976C3.05166 8.04142 3.15358 8.35543 3.0836 8.65535L2.36388 
                                                  11.7399C2.19712 12.4546 2.97221 13.0179 3.60053 12.6387L6.31233 11.0019Z"
                                                fill="#FDB52A"
                                            />
                                        </svg>
                                        <svg width="14" height="13" viewBox="0 0 14 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path
                                                ...
                                                7.83976L13.0602 5.76327C13.6149 5.28274 13.3184 4.37155 12.5871 4.30953L9.43297 4.04202C9.12635
                                                 4.01602 8.8593 3.82243 8.73921 3.53911L7.5049 0.626969C7.21901 -0.0475323 6.26307 -0.0475302 5.97718 
                                                 0.626969L4.74286 3.53911C4.62277 3.82243 4.35573 4.01602 4.04911 4.04202L0.894962 4.30953C0.163677 
                                                 4.37155 -0.13286 5.28273 0.421853 5.76327L2.81888 7.83976C3.05166 8.04142 3.15358 8.35543 3.0836 
                                                 8.65535L2.36388 11.7399C2.19712 12.4546 2.97221 13.0179 3.60053 12.6387L6.31233 11.0019Z"
                                                fill="#FDB52A"
                                            />
                                        </svg>
                                    </div>
                        ...
                        <div className="lg:w-1/2">
                            <div className="heading mb-5 text-center ltr:lg:text-left rtl:lg:text-right">
                                ...
                                <p className="mt-4 text-lg font-semibold">
                                    We will help a clients problems to develop the products they have with high quality Change the appearance.
                                </p>
                            </div>
                        </div>
                            ...
                            <div className="flex gap-5" data-aos="fade-up" data-aos-duration="1000">
                                <div className="h-10 w-10 flex-none text-black dark:text-white">
                                    <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path
                                            d="M9.25175 22.8926H2.67813C1.58662 22.8926 0.701782 23.7774 
                                            0.701782 24.8689V36.8477C0.701782 37.9392 1.58662 38.8241 2.67813 
                                            38.8241H9.25175C10.3433 38.8241 11.2281 37.9392 11.2281 36.8477V24.8689C11.2281
                                             23.7774 10.3433 22.8926 9.25175 22.8926Z"
                                            fill="#47BDFF"
                                        />
                                        <path
                                            d="M22.936 12.0098H16.3623C15.2708 12.0098 14.386 
                                            12.8946 14.386 13.9861V36.8482C14.386 37.9397 15.2708 38.8245 
                                            16.3623 38.8245H22.936C24.0275 38.8245 24.9123 37.9397 24.9123 
                                            36.8482V13.9861C24.9123 12.8946 24.0275 12.0098 22.936 12.0098Z"
                                            fill="currentColor"
                                        />
                                        <path
                                            d="M36.6202 0.929688H30.0465C28.955 0.929688 
                                            28.0702 1.81453 28.0702 2.90604V36.8481C28.0702 
                                            37.9396 28.955 38.8244 30.0465 38.8244H36.6202C37.7117 38.8244 38.5965 37.9396 38.5965 36.8481V2.90604C38.5965 1.81453 37.7117 0.929688 36.6202 0.929688Z"
                                            fill="#B476E5"
                                        />
                                    </svg>
                                </div>
